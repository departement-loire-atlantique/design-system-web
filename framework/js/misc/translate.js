    ...
    static getDictionnary () {
        return ({
            'fr': {
                ...
                'FIELD_VALID_COMPARE': '{fieldName} n\'est pas identique à {fieldNameCompare}',
            ...
            'en': {
                ...
                'FIELD_VALID_COMPARE': '{fieldName} is not equal to {fieldNameCompare}',
